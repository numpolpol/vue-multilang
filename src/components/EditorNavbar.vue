  ...
  <div class="navbar bg-gradient-to-r from-base-100 to-base-200 shadow-xl border-b border-base-300 flex-shrink-0 px-6">
    ...
    <div class="navbar-end">
      ...
      <button 
        ...
        :title="hasUnsavedChanges ? 'You have unsaved changes - Click to save' : 'Project saved'"
      >
        <div class="flex items-center gap-2">
          ...
          <div v-if="hasUnsavedChanges" class="w-2 h-2 bg-current rounded-full animate-pulse"></div>
        </div>
      </button>
