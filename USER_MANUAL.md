...
2. ใส่ชื่อโปรเจคในช่อง "Project Name"
3. คลิกปุ่ม **"Create Project"**
4. ระบบจะพาไปหน้า Editor พร้อมสร้าง:
   - ภาษา English เริ่มต้น
   - Initial keys: `common_ok` และ `common_cancel` (empty values)

### วิธีที่ 2: สร้างจาก iOS .strings Code
1. คลิกการ์ด **"Create from Snippet"**
2. ใส่ชื่อโปรเจคในช่อง "Project Name"
3. คลิกปุ่ม **"Create from Code"**
...
5. คลิก **"Continue"**
6. เลือกภาษาจาก dropdown (เช่น Thai, English, etc.)
7. หากเลือก "Other" ให้ใส่ language code (เช่น th, en)
8. คลิก **"Create Project"**
...
### Q: ทำไมเมื่อสร้าง project ใหม่จึงมี common_ok และ common_cancel?
